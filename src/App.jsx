...
export default function App() {
  ...
  // --- REQUIREMENT ---
  const openReqModal = (r = null) => { setEditingReq(r); setReqForm(r ? { requirementType: '', sourceMeetingId: '', acceptanceCriteria: '', approvalStatus: 'Taslak', approvedById: '', babokKnowledgeArea: '', functionalType: '', nfCategory: '', ...r, notes: r.notes || '', moscow: r.moscow || '' } : { name: '', objective: '', module: '', status: 'Taslak', testId: '', notes: '', moscow: '', requirementType: '', sourceMeetingId: '', acceptanceCriteria: '', approvalStatus: 'Taslak', approvedById: '', babokKnowledgeArea: '', functionalType: '', nfCategory: '' }); setShowReqModal(true); };
  const saveReq = () => {
